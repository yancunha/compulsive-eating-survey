...
def main():
    ...
    st.markdown('''
        ...
        **O tratamento deve ser abordado de forma conjunta com intervenções psicológicas e nutricionais**, mas trouxemos a vocês o questionário, para que você possa refletir sobre seu comportamento alimentar e procurar ajuda, se assim necessário.
        ...
        Após responder o questionário, ocorrerá uma correção automática considerando **três** escalas:
    ...
    st.markdown('''**Insira seu nome e email abaixo:** ''')
    ...
    with form:
        ...
        submitted = form.form_submit_button("Clique aqui para ver o Resultado.")
        if submitted:
            score_final = (
                score1 +
                score2 +
